    ...
    <div className="relative">
      ...
      {showConsentDialog && (
        <>
          ...
          {/* Dialog */}
          <div 
            className="fixed inset-x-4 top-1/2 -translate-y-1/2 max-w-md mx-auto bg-white dark:bg-slate-800 rounded-2xl shadow-xl z-50 p-6"
            role="dialog"
          ...
          >
            ...
            <div className="bg-slate-50 dark:bg-slate-700/50 rounded-xl p-4 mb-6">
              <div className="flex items-start gap-3">
                <svg className="w-5 h-5 text-slate-400 dark:text-slate-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
